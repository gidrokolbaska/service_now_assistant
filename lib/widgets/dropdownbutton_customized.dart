...
class _DropdownMenu<T> extends StatefulWidget {
  ...
  final bool? scrollbarTrackAlwaysShow;
  final Offset offset;
  final List<int>? customItemsIndexes;
  final double? customItemsHeight;
          ...
          child: Material(
            ...
            child: ScrollConfiguration(
              ...
              child: PrimaryScrollController(
                ...
                child: Scrollbar(
                  trackVisibility: widget.scrollbarTrackAlwaysShow,
    ...
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        return _DropdownRoutePage<T>(
          ...
          scrollbarTrackAlwaysShow: scrollbarTrackAlwaysShow,
          offset: offset,
...
class DropdownButton3<T> extends StatefulWidget {
  ...
  ///
  /// If the [onChanged] callback is null or the list of [DropdownButton3.items]
  /// is null then the dropdown button will be disabled, i.e. its arrow will be
  /// displayed in grey and it will not respond to input. A disabled button
  /// will display the [DropdownButton3.disabledHint] widget if it is non-null.
  /// If [DropdownButton3.disabledHint] is also null but [DropdownButton3.hint] is
  /// non-null, [DropdownButton3.hint] will instead be displayed.
  /// {@endtemplate}
  ...
  @override
  State<DropdownButton3<T>> createState() => _DropdownButton3State<T>();
}

class _DropdownButton3State<T> extends State<DropdownButton3<T>>
  ...
  @override
  void didUpdateWidget(DropdownButton3<T> oldWidget) {
  ...
  void _handleTap() {
    ...
    _dropdownRoute = _DropdownRoute<T>(
      ...
      scrollbarTrackAlwaysShow: widget.scrollbarTrackAlwaysShow,
...
/// A [FormField] that contains a [DropdownButton3].
///
/// This is a convenience widget that wraps a [DropdownButton3] widget in a
/// [FormField].
///
...
/// See also:
///
///  * [DropdownButton3], which is the underlying text field without the [Form]
///    integration.
class DropdownButtonFormField2<T> extends FormField<T> {
  /// Creates a [DropdownButton3] widget that is a [FormField], wrapped in an
  /// [InputDecorator].
  ///
